...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Check if there's a saved audio state in localStorage and apply it
  let savedAudioState = localStorage.getItem('isPlaying');
  ...
  // Ensure audio plays or pauses when the window gains or loses focus
  window.onfocus = function() {
      let isPlaying = localStorage.getItem('isPlaying');
      if (isPlaying === 'true' && soundButton.classList.contains('paused') === false) {
          audio.play();
      }
  };
